...
class HDRCC_2_share(BaseModel):
	...
	def initialize(self, opt):
		...
		#  scale 2
		self.input_A_256 = self.Tensor(opt.batchSize, opt.input_nc,	np.int32(opt.fineSize/2), np.int32(opt.fineSize/2))
		self.input_B_256 = self.Tensor(opt.batchSize, opt.output_nc,np.int32(opt.fineSize/2), np.int32(opt.fineSize/2))
		self.input_region_256 = self.Tensor(opt.batchSize, 1, np.int32(opt.fineSize/2), np.int32(opt.fineSize/2))
		self.input_disk_256 = self.Tensor(opt.batchSize, 1,np.int32(opt.fineSize/2), np.int32(opt.fineSize/2))
