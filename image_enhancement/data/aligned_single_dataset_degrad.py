...
class AlignedDatasetspera_Single(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        B_region_256 = cv2.resize(B_region,(np.int32(self.opt.fineSize/2), np.int32(self.opt.fineSize/2)))
        ...
        B_disk_256 = cv2.resize(B_disk, (np.int32(self.opt.fineSize / 2), np.int32(self.opt.fineSize / 2)))
        ...
        A_img_256 = cv2.resize(A_img_256,(np.int32(self.opt.fineSize/2), np.int32(self.opt.fineSize/2)))
        A_img_256 = np.array(A_img_256).transpose(2,0,1)

        B_img_256 = np.array(B_img).transpose(1, 2, 0)
        B_img_256 = cv2.resize(B_img_256,(np.int32(self.opt.fineSize/2), np.int32(self.opt.fineSize/2)))
